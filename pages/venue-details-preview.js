...
class VenueDetails extends React.Component {
	...
	async componentDidMount() {
		...
		try {
			...
			const restaurant_images = await fetchRestaurantImages({id:this.props.restaurant._id});
	...
	render() {
		const { user, restaurant, certificates, menu, currentStep, events, images, rating_value, review_text, bookmarked, visited, additionalDetails, reviewed, states, restaurant_reviews, all_reviews, recent_reviews, popular_reviews, review_fetched, restaurant_images_fetched, events_fetched, restaurant_image, event_image, featuresLimit } = this.state;
		...
		if(!slider_images.length){
			slider_images[0] = {image:'https://totb-data.s3-ap-southeast-2.amazonaws.com/static/1150x672.png'};
			slider_images[1] = {image:'https://totb-data.s3-ap-southeast-2.amazonaws.com/static/1150x672.png'};
			slider_images[2] = {image:'https://totb-data.s3-ap-southeast-2.amazonaws.com/static/1150x672.png'};
		}
								...
								<div className="row">
									<div className="col-6">
										<div className="tag-left">
											...
											return el.name;
											}).join(' · ')}<span className={restaurant.restaurant_types.length > 0 ? 'd-none' : ''}>[Venue Types will be displayed here]</span></p>
										</div>
									</div>
									<div className="col-6">
										<div className="tag-rgt">
											<button className="btn btn-white ml-2" type="submit"><i className="fa fa-star" aria-hidden="true"></i><span className="hide">Rate</span></button>
											<button className="btn btn-white ml-2" type="submit"><i className="fa fa-bookmark" aria-hidden="true"></i><span className="hide">Bookmark</span></button>
								...
								<div className="venue-wrap d-none d-md-flex">
									<div className="lft-box pr-3">
										<div className="vn-img img-horizontal" data-toggle="modal" data-target="#galleryModal">
											<a data-slide-to="4" href="#gallery-thumb"><img style={slider_images.length > 0 ? {} : {display:'none'}} src={slider_images.length > 0 ? slider_images[0].image : ''} alt="img" width="800" height="468" />
											</a>
										</div>
									</div>
									<div className="rgt-box pl-3">
										<div className="vn-img img-vertical mr-btm" data-toggle="modal" data-target="#galleryModal">
											<a data-slide-to="5" href="#gallery-thumb" style={{maxWidth:'702px',maxHeight:'332px',overflow:'hidden',display:'block'}}>
												<img style={slider_images.length > 0 ? {} : {display:'none'}} src={slider_images.length > 1 ? slider_images[1].image : ''} alt="img" width="488" height="231" /></a>
										</div>
										<div className="vn-img img-vertical mr-tp" data-toggle="modal" data-target="#galleryModal">
											<a data-slide-to="6" href="#gallery-thumb" style={{maxWidth:'702px',maxHeight:'332px',overflow:'hidden',display:'block'}}>
												<img style={slider_images.length > 0 ? {} : {display:'none'}} src={slider_images.length > 2 ? slider_images[2].image : ''} alt="img" width="488" height="231" /></a>
										</div>
									</div>
								...
								<div className="venue-wrap-slider d-flex d-md-none">
									<div id="venue-thumb" className="venue-slider carousel slide  carousel-thumbnails" data-ride="carousel">
										...
										<ol className="carousel-indicators">
											{images.map(function(image, index){
												return (
													<li data-target="#venue-thumb" data-slide-to={index} className={index == 0 ? 'active' : ''}></li>
												);
											})}
										</ol>
									</div>
								...
								<div className="modal-content">
									...
									<div id="gallery-thumb" className="carousel slide carousel-fade carousel-thumbnails" data-ride="carousel">
										...
										<ol className="carousel-indicators">
											{images.map(function(image, index){
												return (
													<li data-target="#gallery-thumb" data-slide-to={index} className={index == 0 ? 'active' : ''}><img className="d-block" src={image.image} className="img-fluid" /></li>
												);
											})}
															...
															<div className="col-12 bord-btm">
																<div className="about-tab">
																	...
																	<div className="event-types">
																		<div className="event">
																			<a href="#"><span><i className="fa fa-file-pdf-o" aria-hidden="true"></i></span>Private Events 2019</a>
																		</div>
																		<div className="event">
																			<a href="#"><span><i className="fa fa-file-pdf-o" aria-hidden="true"></i></span>Chrismas Parties</a>
																		</div>
																		<div className="event">
																			<a href="#"><span><i className="fa fa-file-pdf-o" aria-hidden="true"></i></span>EOFY Parties 2019</a>
																		</div>
																	</div>*/}
																</div>
															</div>
																	...
																	<div className="list">
																		<ul className="col-12 pl-0">
																			{features.map(function(feature, index){
																				...
																				return (
																					<li className="col-3 pl-0" key={index} style={{display:'inline-block'}}><span className="icon icon-dine-drinks"></span>{feature.name}</li>
																				);
																			})}
																		</ul>
																	</div>
															...
															<div key={index} className="sub-event">
																<div className="row">
																	...
																	<div className="event-img">
																		<img src={event_image+event.image} alt="" />
																	</div>
																	</div>
								...
								<div className="col-12 col-md-12">
									...
									<div className="tab-content" id="nav-tabContent">
										<div className="tab-pane fade show active" id="nav-popular" role="tabpanel" aria-labelledby="nav-popular-tab">
											<span style={popular_reviews.length > 0 ? {display:'none'} : {}}>Reviews will be displayed here!</span>
										</div>
										<div className="tab-pane fade" id="nav-recent" role="tabpanel" aria-labelledby="nav-recent-tab">
											<span style={recent_reviews.length > 0 ? {display:'none'} : {}}>Reviews will be displayed here!</span>
										</div>
										<div className="tab-pane fade" id="nav-all-review" role="tabpanel" aria-labelledby="nav-all-review-tab">
											<span style={all_reviews.length > 0 ? {display:'none'} : {}}>Reviews will be displayed here!</span>
										</div>
									</div>
								</div>
								</div>
